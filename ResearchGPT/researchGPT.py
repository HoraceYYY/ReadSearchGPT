...
if __name__ == "__main__":
    ...
    searchDomain = input(colored("\nIf there is a domain you would like to search within, paste any link from the domain. Otherwise enter 'None' \nSearch Domain: ", "blue", attrs=["bold"])).lower()
